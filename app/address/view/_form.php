<style>ng-quill-editor .ql-container {height: 350px;}</style>
<div class="form-group row">
	<label for="detail" class="col-sm-2 col-form-label">{{ massages.address.detail }} <span class="text-danger">*</span> : </label>
	<div class="col-sm-10">
